    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(help_text='Add Pictures', upload_to='attachments/opine')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('category', models.BooleanField(default=True, verbose_name='A field used to separate opine posts from debates')),
                ('summary', models.TextField(help_text="Create a post. <a href='http://commonmark.org/help/' target='_blank'>Markdown supported<a/>", max_length=1000, verbose_name='What is your inspiraion?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='opine.Post')),
        ...
        migrations.AddField(
            ...
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='opine.Post'),
        ),
    ]
