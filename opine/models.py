...
class Post(models.Model):
    ...
    category = models.BooleanField('A field used to separate opine posts from debates', default=True, blank = True)
    ...
    def get_absolute_url(self):
        return reverse('opine:post_detail', args=[self.pk, self.slug])
...
class Attachment(models.Model):
    ...
    file = models.FileField(upload_to='attachments/opine', help_text="Add Pictures")
    def __str__(self):
...
from opine.badwords import badwords
